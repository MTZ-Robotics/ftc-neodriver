...
public class AdafruitNeoDriverImpl extends I2cDeviceSynchDeviceWithParameters<I2cDeviceSynch, AdafruitNeoDriverImpl.Parameters>
    ...
    /**
     * Speed to send the I2C comms
     */
    private static final byte NEOPIXEL_SPEED = 0;
    ...
    protected boolean internalInitialize(@NonNull Parameters parameters) {
        ...
        byte[] bytesSPEED = new byte[]{FunctionRegister.SPEED.bVal, NEOPIXEL_SPEED};
        this.deviceClient.write(BASE_REGISTER_ADDR, bytesSPEED, I2cWaitControl.WRITTEN);
